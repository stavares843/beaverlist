...
class BeaverlistUITests: XCTestCase {
  ...
  func testThemesMenu() throws {
    ...
    collectionViewsQuery /*@START_MENU_TOKEN@*/.buttons[
      "Blueberry Blush"
    ] /*[[".cells.buttons[\"Blueberry Blush\"]",".buttons[\"Blueberry Blush\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
      .tap()
    themesButton.tap()
    collectionViewsQuery /*@START_MENU_TOKEN@*/.buttons[
      "Slate Mist"
    ] /*[[".cells.buttons[\"Slate Mist\"]",".buttons[\"Slate Mist\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
      .tap()
    themesButton.tap()
    collectionViewsQuery /*@START_MENU_TOKEN@*/.buttons[
      "Mystic Twilight"
    ] /*[[".cells.buttons[\"Mystic Twilight\"]",".buttons[\"Mystic Twilight\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
      .tap()
    themesButton.tap()
    app.collectionViews /*@START_MENU_TOKEN@*/.buttons[
      "Sunset Blaze"
    ] /*[[".cells.buttons[\"Sunset Blaze\"]",".buttons[\"Sunset Blaze\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
      .tap()
  }
  ...
  func testDismissSearch() throws {
    ...
    app /*@START_MENU_TOKEN@*/.staticTexts[
      "Cancel"
    ] /*[[".buttons[\"Cancel\"].staticTexts[\"Cancel\"]",".staticTexts[\"Cancel\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
      .tap()
  }
